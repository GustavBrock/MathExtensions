...
namespace MathExtTest
{
    ...
    public class UnitTest
    {
        ...
        public void TestRoundingNative()
        {
            ...
            _test = 10.5d;
            _expected = 0;
            //Assert.AreEqual(_expected, Math.Round(_test, -20, mode), "Very large numbers 3");
        ...
        public void TestRoundingMid()
        {
            ...
            _test = 10.5d;
            _expected = 0;
            Assert.AreEqual(_expected, MathExt.RoundMid(_test, -20, mode), "Very large numbers 3");
        ...
        public void TestRoundingUp()
        {
            ...
            _test = 10.5d;
            _expected = 1e+20;
            Assert.AreEqual(_expected, MathExt.RoundUp(_test, -20, mode), "Very large numbers 3");
